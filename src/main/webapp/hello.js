...
function enableButtons () {
	...
	btn = document.getElementById("input_multiply");
	btn.onclick=function(){multiplication();};
	
	// Update the button label now that the button is active
	btn.value="Click me for a multiplication";
}
...
function multiplication(){
	var first = document.getElementById("first_field").value;
	var second = document.getElementById("second_field").value; 
	var request = gapi.client.helloworldendpoints.multiplication({'first': first, 'second':second});
	request.execute(showMultiplication);
	}
function showMultiplication (response) {
