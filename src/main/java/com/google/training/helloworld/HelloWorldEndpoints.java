...
public class HelloWorldEndpoints {
   ...
   // Declare this method as a method available externally through Endpoints
    ...
    @ApiMethod(name ="multiplication", path = "multiply", httpMethod = HttpMethod.GET)
    public Multiplication multiplication(@Named("first") int f,    @Named("second") int s){
    return new Multiplication(f,s);
    }
